...
waveform_df.loc[(waveform_df['region'] == 'PERI') & (waveform_df['spike_width'] < 0.5), 'neuron_type'] = 'INT'
waveform_df.loc[(waveform_df['region'] == 'PERI') & (waveform_df['spike_width'] >= 0.5), 'neuron_type'] = 'PYR'
waveform_df.to_csv(path_dict['save_path'] / 'waveform_metrics.csv', index=False)
waveform_df = waveform_df[waveform_df['good'] == 1]
