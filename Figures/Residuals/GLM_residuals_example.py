...
plt.tight_layout()
plt.savefig(path_dict['paper_fig_path'] / 'Residuals' / 'GLM_speed_example.pdf')
...
plt.tight_layout()
plt.savefig(path_dict['paper_fig_path'] / 'Residuals' / 'GLM_spatial_example.pdf')
...
sns.despine(trim=True)
plt.tight_layout()
plt.savefig(path_dict['paper_fig_path'] / 'Residuals' / 'GLM_prediction_example.pdf')
...
sns.despine(trim=True)
plt.tight_layout()
plt.savefig(path_dict['paper_fig_path'] / 'Residuals' / 'GLM_residual_example.pdf')
plt.show()