...
axs[0].plot([-150, -100], [0.4, 0.4], color='k', lw=1)
axs[0].text(-125, 0.375, '5 cm', ha='center', va='center')
axs[0].plot([-150, -150], [0.4, 0.5], color='k', lw=1)
axs[0].text(-160, 0.45, '10%', ha='center', va='center', rotation=90)
axs[0].text(-180, 0.6, 'Context decoding accuracy', ha='center', va='center', rotation=90)
plt.subplots_adjust(left=0.05, bottom=None, right=0.99, top=0.85, wspace=0, hspace=None)
asd
