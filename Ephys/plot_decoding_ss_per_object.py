...
# Load in data
path_dict = paths()
per_obj_df = pd.read_csv(join(path_dict['save_path'], 'decode_spikeship.csv'))
...
plt.savefig(join(path_dict['google_drive_fig_path'], 'decoding_spikeship_obj1.pdf'))
...
plt.savefig(join(path_dict['google_drive_fig_path'], 'decoding_spikeship_obj2.pdf'))
...
plt.savefig(join(path_dict['google_drive_fig_path'], 'decoding_spikeship_obj3.pdf'))
